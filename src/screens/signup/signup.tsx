...
export default function SignUpScreen() {
    return (
        <View className="container flex items-center justify-center">
            ...
            Estamos empolgados para tê-lo conosco, <Text className="text-[#1F41BB]">Crie sua conta!</Text>
            </Text>
            <View className="form flex flex-col gap-12 justify-center items-center pb-16">
                ...
                <TextInput placeholder="E-mail" id="email" />
                <TextInput placeholder="Sua Senha" id="password" />
                <ButtonComponent title="Entrar" />
                <Text className="text-[##494949] text-[16px] font-bold">
                <Link href="/register">Já tem conta? Entre agora!</Link>
                </Text>
            </View>
            <View>
                <Text className="text-[#1F41BB] font-bold text-[16px] pb-8">Crie sua conta com</Text>
